#!/usr/bin/env python3
"""
Training Script for Roundabout-v0 Autonomous Driving Agent
Uses PPO with CnnPolicy for vision-based roundabout navigation.
"""
...
def train_roundabout_agent(total_timesteps: int = None, model_save_path: str = None):
    """
    Train a PPO agent for the roundabout-v0 scenario.
    ...
    print(f"🔄 Training Roundabout-v0 Agent")
    print("=" * 50)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train Roundabout-v0 Autonomous Driving Agent")
    parser.add_argument(
        "--timesteps", 
        type=int, 
    ...
    parser.add_argument(
        "--save-path", 
        type=str, 
        default=get_model_path("roundabout"),
