...
Uses PPO with CnnPolicy for vision-based parking maneuvers.
"""
...
def train_parking_agent(total_timesteps: int = None, model_save_path: str = None):
    """
    Train a PPO agent for the parking-v0 scenario.
    ...
    print(f"🅿️ Training Parking-v0 Agent")
    print("=" * 50)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train Parking-v0 Autonomous Driving Agent")
    parser.add_argument(
        "--timesteps", 
        type=int, 
    ...
    parser.add_argument(
        "--save-path", 
        type=str, 
        default=get_model_path("parking"),
