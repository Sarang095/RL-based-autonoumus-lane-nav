#!/usr/bin/env python3
"""
Training Script for Intersection-v0 Autonomous Driving Agent
Uses PPO with CnnPolicy for vision-based intersection navigation.
"""
...
def train_intersection_agent(total_timesteps: int = None, model_save_path: str = None):
    """
    Train a PPO agent for the intersection-v0 scenario.
    ...
    print(f"🚦 Training Intersection-v0 Agent")
    print("=" * 50)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Train Intersection-v0 Autonomous Driving Agent")
    parser.add_argument(
        "--timesteps", 
        type=int, 
    ...
    parser.add_argument(
        "--save-path", 
        type=str, 
        default=get_model_path("intersection"),
